...
def api_generate_ai_summary(pid):
    ...
    context = (
        f"Patient ID: {pid}, Name: {patient.get('name')}, "
        f"Diagnosis: {patient.get('primary_diagnosis')}, "
        f"Vitals: HR {patient.get('Heart_Rate_[hr]')}, SpO2 {patient.get('Oxygen_Saturation_[spo2]')}%, "
...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow-sm border-primary mb-4">
        <div class="card-body bg-light">
            ...
            <div id="ai-box" class="p-3 border rounded bg-white mt-3" style="min-height: 70px; font-family: monospace;">
...
function requestAiSummary() {
    ...
    box.innerHTML = '<div class="d-flex align-items-center text-primary"><div class="spinner-border spinner-border-sm me-2" role="status"></div><span>Generating AI summary using llama.cpp... Please wait.</span></div>';
